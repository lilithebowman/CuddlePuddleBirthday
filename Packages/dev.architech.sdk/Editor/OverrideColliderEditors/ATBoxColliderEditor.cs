...
namespace ArchiTech.SDK.Editor
{
    ...
    public class ATBoxColliderEditor : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            collider = (BoxCollider)target;
            var _editorType = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.BoxColliderEditor");
