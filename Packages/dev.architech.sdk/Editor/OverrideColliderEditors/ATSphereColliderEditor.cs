...
namespace ArchiTech.SDK.Editor
{
    ...
    public class ATSphereColliderEditor : UnityEditor.Editor
    {
        ...
        {
            collider = (SphereCollider)target;
            var _editorType = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.SphereColliderEditor");
